<template>
  ...
  <!-- 分类列表 -->
        ...
        <el-form v-permission="['sys:course:video:student:query']"  ref="queryForm" :model="queryParams" :inline="true"
        ...
        <el-table v-loading="loading" :data="studentList">
          ...
          <el-table-column label="视频标题" align="center" prop="videoTitle" width="350" :show-overflow-tooltip="true"/>
          <el-table-column label="学习时长(分钟)" prop="note" align="center" :show-overflow-tooltip="true" >
          ...
          <el-table-column label="累计学习时长(分钟)" prop="note" align="center" :show-overflow-tooltip="true" >
            <template v-slot="scope">
               {{ (scope.row.cumulativeDuration || 0) | filterSecond}}
            </template>
          </el-table-column>
